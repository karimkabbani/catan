...
(function () {
  ...
  function lobbyShell() {
    const foot = `<div class="lobby-foot"><button class="btn ghost" data-nav="logout">← Switch player</button><button class="btn ghost" data-nav="changepin">Change PIN</button></div>`;
